...
import { configurations, opnId, organizations, resources, servers, users } from "../../assets/constants";
    ...
    <Grid className={styles['header-container']}>
      <Grid container md={10} className={styles["header-links-container"]}>
        ...
        >
          ...
          <Button style={{ background: 'rgb(0 100 155)', fontSize: '12px',color:'#ffffff' }} onClick={handleDashboardBtn}>
        ...
        <Typography className={styles["nav-link"]}>
          <CustomizedMenus menuConfig={opnId} />
        </Typography>
      </Grid>
    </Grid>
  );
